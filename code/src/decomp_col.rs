...
Matrix: SmOracle<MajKey, MinKey, SnzVal>
{
    ...
    let mut heap_majoper = BinaryHeap::new();
    let mut hash_reduced = HashMap::new();
    let mut hash_majoper = HashMap::new();

    let mut row_reduced = HashMap::new();
    let mut row_majoper = HashMap::new();
    ...
    // Order minkeys and push them in indexing.ordered_minind
    heap_reduced.clear();
